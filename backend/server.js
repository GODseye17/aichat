...
// Serve static files for the frontend (if you're serving frontend from the backend)
...
// Start the server
const PORT = process.env.PORT || 5001; // Use Render's dynamic port in production
app.listen(PORT, () => {
